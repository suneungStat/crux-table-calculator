...
'<table>\
    ...
    <li>유효하지 않은 원점수를 입력하면 결과가 "X"로 나옵니다.<br>\
        <span style="color:blue">\
            *** 유효한 원점수란? ***<br>\
            1) 국어, 수학, 영어: 0부터 100까지의 정수 (1과 99는 유효하지 않음)<br>\
            2) 한국사, 탐구: 0부터 50까지의 정수 (1과 49는 유효하지 않음)<br>\
...
<ul>\
    ...
    <li>\
        ...
        <span style="color:blue">\
            *** 유효한 원점수란? ***<br>\
            1-1) 국어 공통과목: 0부터 76까지의 정수 (1과 75는 유효하지 않음)<br>\
            1-2) 국어 선택과목: 0부터 24까지의 정수 (1과 23은 유효하지 않음)<br>\
            2-1) 수학 공통과목: 0부터 74까지의 정수 (1과 73은 유효하지 않음)<br>\
            2-2) 수학 선택과목: 0부터 26까지의 정수 (1과 25는 유효하지 않음)<br>\
            3) 영어: 0부터 100까지의 정수 (1과 99는 유효하지 않음)<br>\
            4) 한국사, 탐구: 0부터 50까지의 정수 (1과 49는 유효하지 않음)<br>\
...
<ul>\
    ...
    <li>\
        국어, 수학에서 선택과목 원점수는 선택 사항이며, 공란으로 두거나 유효하지 않은 값을 입력하면 가능한 원점수의 <strong>전체 범위</strong>가 출력됩니다. 유효한 선택과목 원점수를 입력하시면 범위를 좁힐 수 있습니다.<br>\
        <span style="color:blue">\
            *** 유효한 선택과목 원점수란? ***<br>\
            1) 국어: 0부터 24까지의 정수 (1과 23는 유효하지 않음)<br>\
            2) 수학: 0부터 26까지의 정수 (1과 25는 유효하지 않음)<br>\
        </span>\
    </li>\
    <li>\
        국어, 수학에서 결과로 출력된 원점수는 <strong>공통과목 원점수와 선택과목 원점수가 합산</strong>된 값입니다.<br> \
        공통과목 원점수만 따로 알고싶은 경우에는 \'결괏값\'에서 \'선택과목 원점수\'를 빼서 구하시면 됩니다.<br>\
    </li>\
    <li>\
